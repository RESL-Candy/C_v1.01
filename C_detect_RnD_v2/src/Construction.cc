...
G4VPhysicalVolume* MyDetectorConstruction::Construct()
{
  ...
  */
  ...
  G4double GUIDE_MIN_RADIAL = 50.*mm;
  G4double GUIDE_MAX_RADIAL = 50.*mm;
  G4double GUIDE_height = 60*mm;

  G4Cons * GUIDE_Sol = new G4Cons("LAB_GUIDE_L",
				  GUIDE_AXIAL,
				  GUIDE_MIN_RADIAL,
				  GUIDE_AXIAL,
				  GUIDE_MAX_RADIAL,
  ...
  G4LogicalVolume* GUIDE_Log = new G4LogicalVolume(GUIDE_Sol,
						     fMat_LAB,
						     "GUIDE_Log_L");
    
  G4VPhysicalVolume* GUIDE_1 = new G4PVPlacement(nullptr,
		    G4ThreeVector(0., 0., -0.5*(LS_height+2.*GUIDE_height)),
		    GUIDE_Log,
		    "GUIDE_phy",
		    teflonLog,  
		    false,
  ...
  G4VPhysicalVolume* GUIDE_2 = new G4PVPlacement(rotM,
		    G4ThreeVector(0., 0., 0.5*(LS_height+2.*GUIDE_height)),
		    GUIDE_Log,
		    "GUIDE_phy",
		    teflonLog,  
  ...
  for(G4int i=0; i<2; i++)
    {
      PMT_pos_z=(GUIDE_height*4.+LS_height+PMT_height)*0.5*(2*i-1);     
